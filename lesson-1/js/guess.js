// STEP 1: Initialize game variables
			...
			let guessCount = 1;
			// STEP 1e: Variable for reset button
			let resetButton;
			...
			function setGameOver() {
				...
				// STEP 4c: Create a new game button
				resetButton = document.createElement("button");
				document.body.append(resetButton);
				resetButton.textContent = "new game";
				resetButton.addEventListener("click", resetGame);
			}
			// STEP 5: Create a function called resetGame
			function resetGame(){
				// STEP 5a: Restore the guessCount to 1
				guessCount = 1;
				...
				// STEP 5g: generate new random number
